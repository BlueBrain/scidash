...
MODELS = os.path.dirname(os.path.realpath(__file__))
...
class KaliFreund(sciunit.Model,
    ...
    def __init__(self, name="Kali"):
        ...
        modelpath = os.path.join(MODELS,"hoc_models/Kali_Freund_modell/scppinput/")
    ...
    def initialise(self):
        # load cell
        h.load_file(os.path.join(MODELS,"hoc_models/Kali_Freund_modell/scppinput/ca1_syn.hoc"))
...
class Migliore(sciunit.Model,
    ...
    def __init__(self, name="Migliore"):
        ...
        modelpath = os.path.join(MODELS,"hoc_models/Migliore_Schizophr/")
        libpath = "x86_64/.libs/libnrnmech.so.0"

        if os.path.isfile(os.path.join(modelpath,libpath)) is False:
            os.system("cd " + modelpath + "; nrnivmodl")

        h.nrn_load_dll(os.path.join(modelpath,libpath))
    ...
    def initialise(self):
        # load cell
        h.load_file(os.path.join(MODELS,"hoc_models/Migliore_Schizophr/basic_sim_9068802-test.hoc"))
...
class Bianchi(sciunit.Model,
    ...
    def __init__(self, name="Bianchi"):
        ...
        modelpath = os.path.join(MODELS,"hoc_models/Ca1_Bianchi/experiment/")
        libpath = "x86_64/.libs/libnrnmech.so.0"
    ...
    def initialise(self):
        # load cell
        file_path = os.path.join(MODELS,"hoc_models/Ca1_Bianchi/experiment/basic.hoc")
...
class Golding(sciunit.Model,
    ...
    def __init__(self, name="Golding"):
        ...
        modelpath = os.path.join(MODELS,"hoc_models/Golding_dichotomy/fig08/")
        libpath = "x86_64/.libs/libnrnmech.so.0"

        dll_path = os.path.join(modelpath,libpath)
        if os.path.isfile(dll_path) is False:
            os.system("cd " + modelpath + "; nrnivmodl")
    ...
    def initialise(self):
        # load cell
        file_path = os.path.join(MODELS,"hoc_models/Golding_dichotomy/fig08/run_basic.hoc")
        h.load_file()
